...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 10117 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 2662 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 5865 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 5534 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 11027 };
      job.tasks = [task];
      const employee: IEmployee = { id: 30154 };
      job.employee = employee;
