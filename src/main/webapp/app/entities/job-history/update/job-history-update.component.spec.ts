...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 9334 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 8125 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 4643 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 5886 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 12681 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 17410 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 12141 };
      jobHistory.job = job;
      const department: IDepartment = { id: 22599 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 29672 };
      jobHistory.employee = employee;
